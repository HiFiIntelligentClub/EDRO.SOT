...
function сДоСимвола($_сВход, $_сДо='?') // Слово
	{
	$сСлово		='';
	if(empty($_сВход))
	    {
...
function сОтСимвола($_сВход, $_сОт='?') // Слово
	{
	$сСлово		='';
	$фСимволНайден	=false;
...
function сНачДоСимвола($_сВход, $_сДо='?') // Слово
	{
	$сСлово		='';
	if(empty($_сВход))
	    {
...
function сНачОтСимвола($_сВход, $_сОт='?') // Слово
	{
	$сСлово		='';
	$фСимволНайден	=false;
	if(empty($_сВход)){$сСлово='';return $сСлово;}
